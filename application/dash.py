...
TOTACOSOSEX = tabla1_f.iloc[0]['GRAND TOTAL']
TASAACOSOSEX = tabla1_f.iloc[0]['tasa_acumulada']
...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/Acososexual/main/Acososexual2015_2021.csv")
    ...
    dbc.Row(
      ...
      " Entre 2015 y 2021 se registraron "+ str(f"{int(TOTACOSOSEX):,}") +" casos, lo que representa una tasa de "+
       str(TASAACOSOSEX) +" delitos por cada 100 mil habitantes. "+
                    ...
                    "Este dashboard analítico se compone de una sección en la cual tratamos el acoso sexual, observamos "
...
#---------Grafica mensual
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.P("Ciudad de México", style={"font-size": 30,"color": "black","background-color": "white"}),
                  ...
                  style={'size': 2,}),
                          html.P(
                          "Las 10 alcaldías con más acoso sexual fueron: Cuauhtémoc (707), Iztapalapa (401), Gustavo A. Madero (350),"
                              " Miguel Hidalgo (264), Coyoacán (255), Álvaro Obregón (226), Benito Juárez (220), Venustiano Carranza "
                              "(191), Tlalpan (154) y Azcapotzalco (135).",
               ...
               dbc.Col(dbc.Button(([html.P("México", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/mx.jpeg?raw=true",
                                    style={'size': 2,}),
                       html.P(
                           "Los 10 municipios con más acoso sexual fueron: Ecatepec de Morelos (440), Toluca (340), Naucalpan de Juárez"
                           "(188), Nezahualcóyotl (140), Tlalnepantla de Baz (138), Tecámac (129), Chalco (111), Cuautitlán Izcalli (110)"
                           ", Atizapán de Zaragoza (107) y Coacalco de Berriozábal (82).",
                              style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
                       ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
    ...
    html.Br(),
          ...
          dbc.Col(dbc.Button(([html.P("Querétaro", style={"font-size": 30,"color": "black","background-color": "white"}),
                       ...
                       html.P(
                           "Los 10 municipios con más acoso sexual fueron: Querétaro (811), San Juan del Río (133), Corregidora (114)"
                           ", El Marqués (110), Cadereyta de Montes (33), Ezequiel Montes (18), Jalpan de Serra (18), Tequisquiapan "
                           "(16), Colón (16) y Tolimán (12).",
                           style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                         'margin-left': '300px',
               ...
               dbc.Col(dbc.Button(([html.P("Jalisco", style={"font-size": 30,"color": "black","background-color": "white"}),
                     ...
                     html.Br(),
                        ...
                        html.P(
                          "Los 10 municipios con más acoso sexual fueron: Guadalajara (443), Zapopan (292), Tonalá (102), Tlajomulco"
                            "de Zúñiga (99), Puerto Vallarta (62), Zapotlán el Grande (23), Lagos de Moreno (20), El Salto (17), Tala"
                            "(15) y Autlán de Navarro (15).",
                           style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
    ...
    #[
        dbc.Row([
                ...
                html.P(
                    ...
                    "Como se indica en cada caso, la información sobre el delito acoso sexual "
