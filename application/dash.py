...
tabla1_f = tabla1[tabla1['Tipo de delito']== 'Acoso sexual' ]
...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/Acososexual/main/Acososexual20152021.csv")
...
bulletedo1 = ("Las 10 alcaldías con más delitos Acoso sexual fueron: "+str(n1edo1)  +" ("+ str(v1edo1)+"), "+str(n2edo1) +" ("+ str(v2edo1)+"), "+str(n3edo1) +" ("+ str(v3edo1)+"), "+str(n4edo1) +" ("+ str(v4edo1)+"), "+str(n5edo1) +" ("+ str(v5edo1)+"), "+str(n6edo1) +" ("+ str(v6edo1)+"), "+str(n7edo1) +" ("+ str(v7edo1)+"), "+str(n8edo1) +" ("+ str(v8edo1)+"), "+str(n9edo1) +" ("+ str(v9edo1) +") y "+str(n10edo1)+" ("+ str(v10edo1)+").")
bulletedo2 = ("Los 10 municipios con más delitos Acoso sexual fueron: "+str(n1edo2) +" ("+ str(v1edo2)+"), "+str(n2edo2) +" ("+ str(v2edo2)+"), "+str(n3edo2) +" ("+ str(v3edo2)+"), "+str(n4edo2) +" ("+ str(v4edo2)+"), "+str(n5edo2) +" ("+ str(v5edo2)+"), "+str(n6edo2) +" ("+ str(v6edo2)+"), "+str(n7edo2) +" ("+ str(v7edo2)+"), "+str(n8edo2) +" ("+ str(v8edo2)+"), "+str(n9edo2) +" ("+ str(v9edo2)+") y "+str(n10edo2) +" ("+ str(v10edo2)+").")
bulletedo3 = ("Los 10 municipios con más delitos Acoso sexual fueron: "+str(n1edo3) +" ("+ str(v1edo3)+"), "+str(n2edo3) +" ("+ str(v2edo3)+"), "+str(n3edo3) +" ("+ str(v3edo3)+"), "+str(n4edo3) +" ("+ str(v4edo3)+"), "+str(n5edo3) +" ("+ str(v5edo3)+"), "+str(n6edo3) +" ("+ str(v6edo3)+"), "+str(n7edo3) +" ("+ str(v7edo3)+"), "+str(n8edo3) +" ("+ str(v8edo3)+"), "+str(n9edo3) +" ("+ str(v9edo3)+") y "+str(n10edo3) +" ("+ str(v10edo3)+").")
bulletedo4 = ("Los 10 municipios con más delitos Acoso sexual fueron: "+str(n1edo4) +" ("+ str(v1edo4)+"), "+str(n2edo4) +" ("+ str(v2edo4)+"), "+str(n3edo4) +" ("+ str(v3edo4)+"), "+str(n4edo4) +" ("+ str(v4edo4)+"), "+str(n5edo4) +" ("+ str(v5edo4)+"), "+str(n6edo4) +" ("+ str(v6edo4)+"), "+str(n7edo4) +" ("+ str(v7edo4)+"), "+str(n8edo4) +" ("+ str(v8edo4)+"), "+str(n9edo4) +" ("+ str(v9edo4)+") y "+str(n10edo4) +" ("+ str(v10edo4)+").")
    ...
    dbc.Row(
       ...
       dbc.Row(
            [
                ...
                html.P(
                    "La Acoso sexual es uno de los delitos más graves de la violencia de género que se vive en el país, "
    ...
    html.Br(),
     ...
     html.Br(),
       html.Br(),
        dbc.Row(
           [
               dbc.Col(html.P("Evolución de la incidencia de Acoso sexual" ),
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.H5("2015", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/Mapa%20acososexual%20Total2015.png?raw=true",
               ...
               dbc.Col(dbc.Button(([html.H5("2016", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/Mapa%20acososexual%20Total2016.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2017", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/Mapa%20acososexual%20Total2017.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2018", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/Mapa%20acososexual%20Total2018.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2019", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/Mapa%20acososexual%20Total2019.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2020", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/Mapa%20acososexual%20Total2020.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2021", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/Mapa%20acososexual%20Total2021.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2022", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/Mapa%20acososexual%20Total2022.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
...
#---------Grafica mensual
    ...
    #títulos
     ...
     dbc.Col(dbc.Button(([html.P("Ciudad de México", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/cdmx.jpeg?raw=true",
                  style={'size': 2,}),
                       html.P(bulletedo3,
     ...
     dbc.Row(
           [          dbc.Col(dbc.Button(([html.P("Querétaro", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/qro.jpeg?raw=true",
               ...
               dbc.Col(dbc.Button(([html.P("Jalisco", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Acososexual/blob/main/application/static/jlo.jpeg?raw=true",
                       style={'size': 2,}),
